...
We propose opening a dedicated skills repository for llm-d to accelerate development of workflows to be carried out with code assistants. The Each llm-d repository will be able to import skills aligned with its specific scope and goals, and new skills will be added incrementally.
